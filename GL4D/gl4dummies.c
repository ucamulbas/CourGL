 ...
 *
 */
double gsu_rand(void) {
  return g_rand() / 7.0;
}

/*!\brief Retourne un nombre pseudo-aleatoire dans l'intervalle [0,
 * +1[. Ici la distribution est une demi-Gaussienne centrée en zéro
 * (le pic).
 *
 * \return un nombre pseudo-aleatoire selon une demi-gaussienne dans
 * l'intervalle [0, +1[
 *
 */
double gu_rand(void) {
  return fabs(gsu_rand());
}
